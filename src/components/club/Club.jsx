...
function Club() {
    ...
    useEffect(() => {
        dispatch(fetchTeams(i18n.language));
    ...
    return (
        <div className="club-container">
            ...
            <div className="background">
                ...
                <button className="btn1">{t("goal1")}</button>
                <button className="btn2">{t("goal2")}</button>
                <button className="btn3">{t("goal3")}</button>
                <button className="btn4">{t("goal4")}</button>
            </div>
                        ...
                        >
                            {teams.map((member) => (
                                <SwiperSlide key={member.id}>
                                    <div className="members" onClick={() => handleCardClick(member)}>
                                        <div>
                                            <img
                                        ...
                                        <p>{getLocalizedText(member.position)}</p>
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
                        ...
                        <div className="modal">
                            ...
                            <div className="modal-content">
                                <div>
                                    ...
                                    />
                                    <p>{getLocalizedText(selectedMember.position)}</p>
                                </div>
                                <div>
                                    <p>{getLocalizedText(selectedMember.bio)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
